#' @title A function that screens relevant publications in terms of common numbers of mesh terms.
#'
#' @description It provides the PMID numbers of a set of publications x which have at least d descriptors and q qualifiers in common with a small default set y. It has a limit of 300 Abstracts (x< 300).
#'
